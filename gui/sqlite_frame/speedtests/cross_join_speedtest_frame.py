...
import sqlite.cross_join_speedtest


def create_sqlite_cross_join_speedtest(frame):
    """
...
def get_cross_join_speedtest_result(searches, label):
    ...
    """
    result = sqlite.cross_join_speedtest.cross_join_speedtest(searches)
...
def modify_cross_join_db(lines, label, lines_string):
    ...
    """
    sqlite.cross_join_speedtest.create_cross_join_db(lines)
