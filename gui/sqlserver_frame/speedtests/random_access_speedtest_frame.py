...
import sqlserver.random_access_speedtest


def create_sqlserver_random_access_speedtest(frame):
    """
...
def get_random_access_speedtest_result(accesses, label):
    ...
    """
    result = sqlserver.random_access_speedtest.random_select_speedtest(accesses)
